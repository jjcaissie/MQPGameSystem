...
def TwentyQuestionsTwo():
    ...
    if request.method == "POST":
        ...
        if isinstance(data, str):
            ...
            return render_template("TwentyQuestionsTwo.html", answer=chatbotResponse+'<br>'+data[0], firstGuess=data[1], secondGuess=data[2], characters=data[3],userQuestions=data[4])
